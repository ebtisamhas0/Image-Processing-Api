...
describe('test the endpoints ', function () {
    ...
    it('test api/image.jpg', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/green.jpg')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(200);
                    return [2 /*return*/];
    ...
    it('test /api/resizedImage', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/resizedImage/?image=see&height=200&width=150')];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(200);
                    return [2 /*return*/];
    ...
    it('expects the return value to be true', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = 'green';
                    return [4 /*yield*/, (0, validation_1.default)(name, 200, 200)];
                case 1:
                    resize = _a.sent();
